...
[![JSS](https://img.shields.io/badge/Journal-JSS-b31b1b)](https://www.sciencedirect.com/science/article/pii/S0164121226003341) [![GitHub Stars](https://img.shields.io/github/stars/messarhi/prompt4aprtax?style=social)](https://github.com/messarhi/prompt4aprtax)
...
📌 We propose a taxonomy that organizes LLM-based prompting strategies for Automated Program Repair into three families — *Context and Structure Awareness*, *Cognitive Reasoning Enhancement*, and *Quality Assurance* — and expose the methodological "reality gaps" (e.g., reliance on perfect fault localization, single-function bug assumptions) that separate current research from industrial deployment.

📄 Paper Link: [Toward effective LLM-based Automated Program Repair: A taxonomy of prompting strategies and key trends, insights, and challenges](https://www.sciencedirect.com/science/article/pii/S0164121226003341)
